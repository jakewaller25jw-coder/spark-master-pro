...
if uploaded_image:
    ...
    3. SMART VALUE, BULK & MULTI-PACK COMBOS:
       - Bulk Size Upgrade: If a larger size/pack is on sale or slightly higher, offer it as a top "Smart Value Upgrade".
       - Quantity Multi-Pack Math: If smaller individual units are priced low, calculate multi-pack options.
